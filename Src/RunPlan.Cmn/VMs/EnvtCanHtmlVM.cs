...
namespace VMs
{
	public class EnvtCanHtmlVM : BindableBase, IRefreshable
	{
		...
		private EnvtCanHtmlVM() { TimeAgo_ = Value = ""; }
		public static EnvtCanHtmlVM Instance { get { return _inst ?? (_inst = new EnvtCanHtmlVM()); } }


		DateTime _lastUpdate = DateTime.MinValue;
		string _TimeAgo_;       /**/public string TimeAgo_ { get { return _TimeAgo_; } set { Set(ref _TimeAgo_, value); } }
		string _Value = "Gas";  /**/public string Value { get { return _Value; } set { Set(ref _Value, value); } }
