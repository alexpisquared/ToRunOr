...
namespace ToRunOr
{
  public sealed partial class MainPage : Page
  {
    ...
    readonly MainPageVM _vm = null;
    readonly DisplayRequest _disp = new DisplayRequest();
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register("MyProperty", typeof(int), typeof(MainPage), new PropertyMetadata(0)); public int MyProperty { get => (int)GetValue(MyPropertyProperty); set => SetValue(MyPropertyProperty, value); }
    ...
    void tgAntiSceenSaver_DataContextChanged(FrameworkElement sender, DataContextChangedEventArgs args) => Debug.WriteLine($" *** isChecked: {tgAntiSceenSaver.IsChecked} \t {tgAntiSceenSaver.Text} ");
  }
}